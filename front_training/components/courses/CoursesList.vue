            ...
            <section class="text-gray-600 body-font">
                <div class="container mx-auto">
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div v-for="(courses, index) in coursesList" :key="index">
                            <div class="p-4">
                                <div class="cards-container">
                                    ...
                                    >
                                        <img
                                            v-if="!!courses.courseImage"
                                            class="lg:h-48 md:h-36 w-full object-cover object-center scale-110 transition-all duration-400 hover:scale-100"
                                            :src="courses.courseImage.image"
                                            alt="blog"
                                        />
                                        <img
                                            v-else
                                        ...
                                        <div class="p-6">
                                            ...
                                            >
                                                {{
                                                    courses.courseType === 'public' ? 'Público' : 'Requiere invitación'
                                                }}
                                            </h2>
                                            ...
                                            <p class="tracking-widest text-xs title-font text-gray-400 mb-1">
                                                ...
                                                {{ courses.createdByObj.getFullName }}
                                            </p>
...
export default {
    ...
    methods: {
        async getCourse() {
            ...
            try {
                this.dataReturned = await this.$store.dispatch('course/getCourseList')

...
PROJECT_DIR = ROOT_DIR.path("training_fyg")
APPS_DIR = ROOT_DIR.path("training_fyg")
...
LOCAL_APPS = [
    "training_fyg.users.apps.UsersConfig",
    "training_fyg.categories.apps.CategoriesConfig",
    "training_fyg.courses.apps.CourseConfig",
]
...
# MIGRATION_MODULES = {"sites": "training_fyg.contrib.sites.migrations"}
...
# ADMINS = [("""Ramses Martinez""", "ramses.martinez@fygsolutions.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "FyG Training API",
    "DESCRIPTION": "FyG Training - Django Spectacular API",
    "VERSION": "1.0.0",
}
...
# GRAPPELLI SETTINGS
# ------------------------------------------------------------------------------
GRAPPELLI_ADMIN_TITLE = "Training fyg"
